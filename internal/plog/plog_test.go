...
func TestPlog(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: here.Doc(`
				{"level":"error","timestamp":"2099-08-08T13:57:36.123456Z","caller":"logr@v1.4.4/logr.go:<line>$logr.Logger.Error","message":"e","panda":2,"error":"some err"}
				...
				{"level":"all","timestamp":"2099-08-08T13:57:36.123456Z","caller":"logr@v1.4.4/logr.go:<line>$logr.Logger.Info","message":"all","panda":2}
				{"level":"info","timestamp":"2099-08-08T13:57:36.123456Z","caller":"logr@v1.4.4/logr.go:<line>$logr.Logger.Info","message":"always","panda":2}
			`),
		},
		{
			name: "depth -3",
			...
			want: here.Doc(`
				...
				{"level":"info","timestamp":"2099-08-08T13:57:36.123456Z","caller":"logr@v1.4.4/logr.go:<line>$logr.Logger.Info","message":"w","warning":true,"panda":2}
				{"level":"info","timestamp":"2099-08-08T13:57:36.123456Z","caller":"logr@v1.4.4/logr.go:<line>$logr.Logger.Info","message":"we","warning":true,"error":"some err","panda":2}
				{"level":"info","timestamp":"2099-08-08T13:57:36.123456Z","caller":"logr@v1.4.4/logr.go:<line>$logr.Logger.Info","message":"i","panda":2}
				{"level":"info","timestamp":"2099-08-08T13:57:36.123456Z","caller":"logr@v1.4.4/logr.go:<line>$logr.Logger.Info","message":"ie","error":"some err","panda":2}
				{"level":"debug","timestamp":"2099-08-08T13:57:36.123456Z","caller":"logr@v1.4.4/logr.go:<line>$logr.Logger.Info","message":"d","panda":2}
				{"level":"debug","timestamp":"2099-08-08T13:57:36.123456Z","caller":"logr@v1.4.4/logr.go:<line>$logr.Logger.Info","message":"de","error":"some err","panda":2}
				{"level":"trace","timestamp":"2099-08-08T13:57:36.123456Z","caller":"logr@v1.4.4/logr.go:<line>$logr.Logger.Info","message":"t","panda":2}
				{"level":"trace","timestamp":"2099-08-08T13:57:36.123456Z","caller":"logr@v1.4.4/logr.go:<line>$logr.Logger.Info","message":"te","error":"some err","panda":2}
