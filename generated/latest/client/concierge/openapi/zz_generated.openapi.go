...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"go.pinniped.dev/generated/latest/apis/concierge/login/v1alpha1.TokenCredentialRequestSpec":   schema_apis_concierge_login_v1alpha1_TokenCredentialRequestSpec(ref),
		"go.pinniped.dev/generated/latest/apis/concierge/login/v1alpha1.TokenCredentialRequestStatus": schema_apis_concierge_login_v1alpha1_TokenCredentialRequestStatus(ref),
...
func schema_apis_concierge_identity_v1alpha1_WhoAmIRequest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"go.pinniped.dev/generated/latest/apis/concierge/identity/v1alpha1.WhoAmIRequestSpec", "go.pinniped.dev/generated/latest/apis/concierge/identity/v1alpha1.WhoAmIRequestStatus", metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_apis_concierge_identity_v1alpha1_WhoAmIRequestList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"go.pinniped.dev/generated/latest/apis/concierge/identity/v1alpha1.WhoAmIRequest", metav1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_apis_concierge_login_v1alpha1_TokenCredentialRequest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.pinniped.dev/generated/latest/apis/concierge/login/v1alpha1.TokenCredentialRequestSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.pinniped.dev/generated/latest/apis/concierge/login/v1alpha1.TokenCredentialRequestStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"go.pinniped.dev/generated/latest/apis/concierge/login/v1alpha1.TokenCredentialRequestSpec", "go.pinniped.dev/generated/latest/apis/concierge/login/v1alpha1.TokenCredentialRequestStatus", metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_apis_concierge_login_v1alpha1_TokenCredentialRequestList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("go.pinniped.dev/generated/latest/apis/concierge/login/v1alpha1.TokenCredentialRequest"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"go.pinniped.dev/generated/latest/apis/concierge/login/v1alpha1.TokenCredentialRequest", metav1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_apis_concierge_login_v1alpha1_TokenCredentialRequestStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					"credential": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("go.pinniped.dev/generated/latest/apis/concierge/login/v1alpha1.ClusterCredential"),
						},
					},
					"message": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"go.pinniped.dev/generated/latest/apis/concierge/login/v1alpha1.ClusterCredential"},
	}
}
