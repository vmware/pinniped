...
// This is the version of github.com/google/gnostic-models used in v0.34.0 kubernetes libs.
...
// https://github.com/kubernetes/client-go/blob/v0.34.0/go.mod#L12
...
require (
	...
	k8s.io/gengo v0.0.0-20250903151518-081d64401ab4
